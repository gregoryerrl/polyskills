...
| `polyskills:visual-explainer` | Interactive HTML explainer pages — full creative use of HTML (Canvas, SVG, animations, interactive elements, color-coded layouts, diagrams) | "explain visually", "visualize this", "teach me about", "create explainer" |
...
- visual-explainer: every section must have at least one visual element — creative freedom on what (diagrams, animations, interactive widgets, color-coded text, cards, anything HTML can render), strict standards on how (theme-aware, responsive, performant, working interactions)
